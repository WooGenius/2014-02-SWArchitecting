 ...
 */
public /*package*/ class UserListJSONImpl extends TwitterResponseImpl implements UserList, java.io.Serializable {
    ...
    /*package*/ public UserListJSONImpl(JSONObject json) throws TwitterException {
        super();
        init(json);
    }
