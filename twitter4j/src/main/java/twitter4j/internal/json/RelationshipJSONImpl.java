 ...
 */
public /*package*/ class RelationshipJSONImpl extends TwitterResponseImpl implements Relationship, java.io.Serializable {
    ...
    /*package*/ public RelationshipJSONImpl(JSONObject json) throws TwitterException {
        this(null, json);
    }
